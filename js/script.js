...
// v5.10 - bip électronique type C4 sur les interactions du site
...
function playC4Click(){
  try{
    // Clone pour que les clics rapides puissent se chevaucher proprement.
...
document.addEventListener('click',(event)=>{
  const interactive = event.target.closest(
    '.navbar a, .navbar button, .hero-actions .btn, .join-actions .btn, summary'
  );
